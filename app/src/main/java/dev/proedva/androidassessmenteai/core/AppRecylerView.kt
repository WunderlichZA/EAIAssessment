...
/*class AppRecyclerViewAdapter <T : Any, VM : ViewDataBinding>(
    @LayoutRes val layoutID: Int,
    private val bindingInterface: AppRecyclerBindingInterface<VM, T>,
    private val clickListener: GenericClickListener<T>? = null
) :
    ListAdapter<T, AppRecyclerViewAdapter.AppRecyclerViewHolder>(
        GenericDiffUtilCallback()
    ) {


    class AppRecyclerViewHolder(private val binding: ViewDataBinding) :
...
interface AppRecyclerBindingInterface<VM : ViewDataBinding, T : Any> {
